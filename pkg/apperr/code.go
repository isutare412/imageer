...
var (
	...
	CodeRequestEntityTooLarge = Code{8000, "REQUEST_ENTITY_TOO_LARGE"}

	// 422 Unprocessable Entity
	CodeUnprocessableEntity = Code{9000, "UNPROCESSABLE_ENTITY"}

	// 429 Too Many Requests
	CodeTooManyRequests = Code{10000, "TOO_MANY_REQUESTS"}

	// 500 Internal Server Error
	CodeInternalServerError = Code{11000, "INTERNAL_SERVER_ERROR"}

	// 501 Not Implemented
	CodeNotImplemented = Code{12000, "NOT_IMPLEMENTED"}

	// 503 Service Unavailable
	CodeServiceUnavailable = Code{13000, "SERVICE_UNAVAILABLE"}
)
